...
class AttentionBlock(nn.Module):
    """
    Implementation by Ed Blewitt of the attention block, as described in Yang et al.'s paper: https://doi.org/10.1109/TMI.2025.3597401
    ...
    def __init__(self, in_channels=1, features=64):
        ...
        # Define the downsampling branches
        ...
        def residual_block(channels):
            """
            Returns a single residual block with specific number of channels

            Args:
                channels (int): The number of channels for the convolutional layers in the block
        
            Returns:
                A nn.Sequential wrapper containing residual bloick layers
        ...
        # Define upsampling branch for weights
        ...
        # Define upsampling branch for content (I_content)
    ...
    def forward(self, x):
        """
        Defined the forward process of the attention block
