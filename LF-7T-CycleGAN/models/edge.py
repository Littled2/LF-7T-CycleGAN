...
class EdgeBlock(nn.Module):
    """
    Implementation by Ed Blewitt of the edge block, as described in Yang et al.'s paper: https://doi.org/10.1109/TMI.2025.3597401
    ...
    def forward(self, x):
        """
        Executes the forward pass of the edge block
        ...
        # Run the decoder side, including skip connections
