...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--name", type=str, default="experiment_name", help="name of the experiment. It decides where to store samples and models. For deep ensemble models please prefix name with DE_*")
